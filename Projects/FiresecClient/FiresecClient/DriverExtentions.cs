...
namespace FiresecClient
{
    public static class DriverExtentions
    {
        ...
        public static bool IsIgnore(this Firesec.Metadata.configDrv driver)
        {
            return (driverDataList.FirstOrDefault(x => (x.DriverId == driver.id)).IgnoreLevel > 0);
        }
        ...
        public static string ImageSource(this Firesec.Metadata.configDrv driver)
        {
            string ImageName;
        ...
        public static bool HasImage(this Firesec.Metadata.configDrv driver)
        {
            return driver.ImageSource() != @"C:/Program Files/Firesec/Icons/Device_Device.ico";
        }

        public static bool CanEditAddress(this Firesec.Metadata.configDrv driver)
        {
        ...
        public static bool CanAddChildren(this Firesec.Metadata.configDrv driver)
        {
        ...
        public static bool IsZoneDevice(this Firesec.Metadata.configDrv driver)
        {
            return !((driver.minZoneCardinality == "0") && (driver.maxZoneCardinality == "0"));
        }

        public static bool IsZoneLogicDevice(this Firesec.Metadata.configDrv driver)
        {
