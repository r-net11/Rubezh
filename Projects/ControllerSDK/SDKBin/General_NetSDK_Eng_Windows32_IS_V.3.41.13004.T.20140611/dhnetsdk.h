...
typedef enum _EXTPTZ_ControlType
{
	...
	DH_EXTPTZ_VERSECTORSCAN = 0x4C,             // Vertical sweep fan(param4对应PTZ_CONTROL_SECTORSCAN,param1、param2、param3 is invalid)
...
// Download progress callback function prototypes， nError Indicates that an error occurred during the download of，1-缓存不足，2-对返回数据的校验出错，3-下载当前文件失败，4-创建对应保存文件失败
