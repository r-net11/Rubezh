...
namespace ControllerSDK
{
	public class CardsViewModel : BaseViewModel
	{
		...
		public ObservableCollection<ControllerSDK.SDKImport.NET_ACCESSCTLCARD_STATE> AvailableCardStatuses { get; private set; }

		ControllerSDK.SDKImport.NET_ACCESSCTLCARD_STATE _cardStatus;
		public ControllerSDK.SDKImport.NET_ACCESSCTLCARD_STATE CardStatus
		{
		...
		public ObservableCollection<ControllerSDK.SDKImport.NET_ACCESSCTLCARD_TYPE> AvailableCardTypes { get; private set; }

		ControllerSDK.SDKImport.NET_ACCESSCTLCARD_TYPE _cardType;
		public ControllerSDK.SDKImport.NET_ACCESSCTLCARD_TYPE CardType
		{
