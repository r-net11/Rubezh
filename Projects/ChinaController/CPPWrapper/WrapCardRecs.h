...
extern "C" CLIENT_API BOOL CALL_METHOD WRAP_BeginGetAll_CardRecs(int loginID, int& finderID);
extern "C" CLIENT_API int CALL_METHOD WRAP_GetAll_CardRecs(int finderID, CardRecsCollection* result);
