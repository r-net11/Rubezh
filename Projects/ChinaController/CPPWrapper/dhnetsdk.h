...
#define DH_DEVSTATE_ALARM_FAULT_STATE     0x1566           // 获取故障状态(对应NET_ALARM_FAULT_STATE_INFO)
#define DH_DEVSTATE_DEFENCE_STATE         0x1567           // 获取防区状态(对应NET_DEFENCE_STATE_INFO, 和旁路状态变化事件、本地报警事件、报警信号源事件的状态描述有区别，不能混用，仅个别设备使用)
...
#define DH_ALARM_RCEMERGENCY_CALL         0x318b           // 紧急呼叫报警事件(对应结构体ALARM_RCEMERGENCY_CALL_INFO)
...
{
    NET_RECORD_UNKNOWN,
    NET_RECORD_TRAFFICREDLIST,                          // 交通白名单账户记录，对应 FIND_RECORD_TRAFFICREDLIST_CONDITION
    ...
    NET_RECORD_TRAFFICFLOW_STATE,                       // 查询交通流量记录，对应 FIND_RECORD_TRAFFICFLOW_CONDITION
}EM_NET_RECORD_TYPE;
...
#define MAX_ALARMEXT_MODULE_NUM          8                  // 最大扩展模块数目
