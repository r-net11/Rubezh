...
extern "C" CLIENT_API int CALL_METHOD WRAP_Insert_Holiday(int loginID, NET_RECORDSET_HOLIDAY* param);

extern "C" CLIENT_API int CALL_METHOD WRAP_Update_Holiday(int loginID, NET_RECORDSET_HOLIDAY* param);

extern "C" CLIENT_API BOOL CALL_METHOD WRAP_Remove_Holiday(int loginID, int recordNo);

extern "C" CLIENT_API BOOL CALL_METHOD WRAP_RemoveAll_Holidays(int loginID);

extern "C" CLIENT_API BOOL CALL_METHOD WRAP_Get_Holiday_Info(int loginID, int recordNo, NET_RECORDSET_HOLIDAY* result);
