...
{
    CFG_ENUM_NET_TRANSMISSION_MODE_ADAPT,               // adapt
    CFG_ENUM_NET_TRANSMISSION_MODE_HALF10M,             // half 10M
    CFG_ENUM_NET_TRANSMISSION_MODE_FULL10M,             // full 10M
    CFG_ENUM_NET_TRANSMISSION_MODE_HALF100M,            // half 100M
    CFG_ENUM_NET_TRANSMISSION_MODE_FULL100M,            // full 100M
...
{
	BOOL					bEnable;								// enable, it indicates whether to open the detection function
