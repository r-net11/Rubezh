...
BEGIN
    ...
    PUSHBUTTON      "Confirm",IDC_SUBSCRIBE_BTN_CONFIRM,307,38,50,14,NOT 
                    WS_VISIBLE
    LTEXT           "Channel:",IDC_STATIC,254,19,33,8,NOT WS_VISIBLE
    COMBOBOX        IDC_SUBSCRIBE_CMB_CHN,296,17,94,113,CBS_DROPDOWNLIST | 
                    CBS_SORT | NOT WS_VISIBLE | WS_VSCROLL | WS_TABSTOP
    LTEXT           "AlarmType:",IDC_STATIC,94,19,41,8,NOT WS_VISIBLE
    COMBOBOX        IDC_SUBSCRIBE_CMB_TYPE,145,17,97,81,CBS_DROPDOWNLIST | 
                    CBS_SORT | NOT WS_VISIBLE | WS_VSCROLL | WS_TABSTOP
    LTEXT           "Password:",IDC_STATIC,93,39,48,8,NOT WS_VISIBLE
...
BEGIN
    ...
    CONTROL         "DateTimePicker2",IDC_QUERYLOG_DATETIMEPICKER_STARTTIME,
                    ...
                    WS_VISIBLE | WS_DISABLED | WS_TABSTOP | 0x8,166,20,54,15
    CONTROL         "DateTimePicker2",IDC_QUERYLOG_DATETIMEPICKER_ENDTIME,
                    "SysDateTimePick32",DTS_RIGHTALIGN | DTS_UPDOWN | NOT 
                    WS_VISIBLE | WS_DISABLED | WS_TABSTOP | 0x8,306,20,53,15
    CONTROL         "DateTimePicker4",IDC_QUERYLOG_DATETIMEPICKER_STARTDAY,
                    "SysDateTimePick32",DTS_RIGHTALIGN | NOT WS_VISIBLE | 
                    WS_DISABLED | WS_TABSTOP,100,20,62,15
    LTEXT           "To",IDC_STATIC,226,23,12,10,NOT WS_VISIBLE | 
                    WS_DISABLED
    CONTROL         "DateTimePicker5",IDC_QUERYLOG_DATETIMEPICKER_ENDDAY,
                    "SysDateTimePick32",DTS_RIGHTALIGN | NOT WS_VISIBLE | 
                    WS_DISABLED | WS_TABSTOP,241,20,61,15
    PUSHBUTTON      "Stop",IDC_QUERYLOG_BTN_QUERYSTOP,401,43,50,14
    PUSHBUTTON      "Start",IDC_QUERYLOG_BTN_QUERYSTART,286,43,50,14
    PUSHBUTTON      "Next",IDC_QUERYLOG_BTN_QUERYNEXT,344,43,50,14
    CONTROL         "List2",IDC_QUERYLOG_LIST_LOGLIST,"SysListView32",
                    LVS_REPORT | LVS_SINGLESEL | WS_BORDER | WS_TABSTOP,13,
                    63,438,207
    LTEXT           "PageLines:",IDC_STATIC,366,23,41,8,NOT WS_VISIBLE | 
                    WS_DISABLED
...
BEGIN
    ...
    EDITTEXT        IDC_RECSET_CARD_EDT_PWD,80,134,48,14,ES_PASSWORD | 
                    ES_AUTOHSCROLL
    RTEXT           "UseTime:",IDC_STATIC,15,196,57,8
...
BEGIN
    ...
    RTEXT           "AlarmPwd:",IDC_STATIC,24,89,59,8
...
BEGIN
    ...
    RTEXT           "RecNo:",IDC_STATIC,30,20,43,8
    ...
    COMBOBOX        IDC_SUBDLG_INFO_ACCESS_COMBO_METHOD,79,145,63,66,
...
BEGIN
    DEFPUSHBUTTON   "StartQuery",IDC_RECORDSETFINDER_BTN_QUERYSTART,27,101,
                    50,14
    RTEXT           "DataType:",IDC_STATIC,54,23,45,8
...
FONT 10, "宋体"
BEGIN
    DEFPUSHBUTTON   "Get",IDC_ACCESSCONTROL_GENERAL_BTN_GET,41,61,50,14
    PUSHBUTTON      "Set",IDC_ACCESSCONTROL_GENERAL_BTN_SET,95,61,50,14
...
BEGIN
    ...
    LTEXT           "DoorOpenTimeSection:",IDC_STATIC,154,109,81,8
    COMBOBOX        IDC_ACCESSCONTROL_CMB_CHANNEL,91,20,48,137,
                    CBS_DROPDOWNLIST | CBS_SORT | WS_VSCROLL | WS_TABSTOP
    RTEXT           "Channel:",IDC_STATIC,39,22,47,8
END
