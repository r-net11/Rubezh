...
#define CFG_CMD_COMMTRANSFER		"CommTransfer"		// 串口透传配置(CFG_COMMTRANSFER_INFO)
...
#define CFG_CAP_CMD_ENCODE_ENCRYPT	"EncodeEncrypt.getCaps"					// 获取通道加编码密配置信息( CFG_ENCODE_ENCRYPT_CHN_INFO )
