...
void Insert_Holiday(LLONG lLoginID, int& nRecrdNo)
{
	...
	stuHoliday.stuStartTime.dwDay = 11;
	...
	stuHoliday.stuEndTime.dwDay = 17;
...
void Update_Card(LLONG lLoginID)
{
	...
	stuCard.nRecNo = g_nRecordNoCard < 0 ? 123457 : g_nRecordNoCard;
...
BOOL DevCtrl_GetLogCount(LLONG lLoginID)
{
	...
	stuGetLog.stuStartTime.dwYear = 2023;
	...
	stuGetLog.stuEndTime.dwYear = 2025;
	...
	stuGetLog.nStartNum = 1;
	stuGetLog.nLogStuType = 0x3181;
	stuGetLog.nEndNum = 1;
...
BOOL DevCtrl_GetRecordSetInfo(LLONG lLoginID, int nRecordSetType)
{
	...
	{
	case 1:
		stuCard.nRecNo = g_nRecordNoCard < 0 ? 1 : g_nRecordNoCard;
		stuInert.emType = NET_RECORD_ACCESSCTLCARD;
		stuInert.pBuf = &stuCard;
		break;
	case 2:
		stuAccessCtlPwd.nRecNo = g_nRecordNoPwd < 0 ? 1 : g_nRecordNoPwd;
		stuInert.emType = NET_RECORD_ACCESSCTLPWD;
		stuInert.pBuf = &stuAccessCtlPwd;
		break;
	case 3:
		stuCardRec.nRecNo = g_nRecordNoCardRec < 0 ? 1 : g_nRecordNoCardRec;
		stuInert.emType = NET_RECORD_ACCESSCTLCARDREC;
		stuInert.pBuf = &stuCardRec;
		break;
	case 4:
		stuHoliday.nRecNo = g_nRecordNoHoliday < 0 ? 1 : g_nRecordNoHoliday;
		stuInert.emType = NET_RECORD_ACCESSCTLHOLIDAY;
		stuInert.pBuf = &stuHoliday;
		break;
	default:
