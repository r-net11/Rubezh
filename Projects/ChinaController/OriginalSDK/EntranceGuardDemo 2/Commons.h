...
#define DEVCTL_CAPTURE_FINGERPRINT  25      // 抓取指纹

#define DEVCFG_OPEN_DOOR_GROUP_S    26      // 多人组合开门配置(单通道)
#define DEVCFG_OPEN_DOOR_GROUP_A    27      // 多人组合开门配置(多通道)
#define DEVCFG_OPEN_DOOR_ROUTE_S    28      // 开门线路配置(单通道)
#define DEVCFG_OPEN_DOOR_ROUTE_A    29      // 开门线路配置(多通道)

#define DEVCFG_CLIENT_CUSTOM_DATA   30      // 客户自定义数据配置
#define DEVCTL_CONFIRM_BREAKIN      31      // 确认BreakIn事件
