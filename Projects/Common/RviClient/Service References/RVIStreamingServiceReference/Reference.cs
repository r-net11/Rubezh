...
namespace RviClient.RVIStreamingServiceReference {
    ...
    public interface IIntegrationVideoStreaming {
        ...
        RviClient.RVIStreamingServiceReference.VideoFileStreamingOut GetVideoFile(RviClient.RVIStreamingServiceReference.VideoFileStreamingIn request);
    }
    ...
    public partial class IntegrationVideoStreamingClient : System.ServiceModel.ClientBase<RviClient.RVIStreamingServiceReference.IIntegrationVideoStreaming>, RviClient.RVIStreamingServiceReference.IIntegrationVideoStreaming {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        RviClient.RVIStreamingServiceReference.VideoFileStreamingOut RviClient.RVIStreamingServiceReference.IIntegrationVideoStreaming.GetVideoFile(RviClient.RVIStreamingServiceReference.VideoFileStreamingIn request) {
        ...
        public int GetVideoFile(int ChannelNumber, System.Guid DeviceGuid, System.Guid EventGuid, ref System.Guid Request, ref System.Guid Session, out string ErrorInformation, out System.IO.Stream FileContent) {
            RviClient.RVIStreamingServiceReference.VideoFileStreamingIn inValue = new RviClient.RVIStreamingServiceReference.VideoFileStreamingIn();
            inValue.ChannelNumber = ChannelNumber;
            inValue.DeviceGuid = DeviceGuid;
            inValue.EventGuid = EventGuid;
            inValue.Request = Request;
            inValue.Session = Session;
            RviClient.RVIStreamingServiceReference.VideoFileStreamingOut retVal = ((RviClient.RVIStreamingServiceReference.IIntegrationVideoStreaming)(this)).GetVideoFile(inValue);
