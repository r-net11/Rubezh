...
namespace GKProcessor
{
	public static class RSR2_MVP_Helper
	{
		public static GKDriver Create()
		{
			...
			GKDriversHelper.AddHiddenProperty(driver, 0, "Число АУ на АЛС3 МВП").CanNotEdit = true;
			GKDriversHelper.AddHiddenProperty(driver, 1, "Число АУ на АЛС4 МВП").CanNotEdit = true;
