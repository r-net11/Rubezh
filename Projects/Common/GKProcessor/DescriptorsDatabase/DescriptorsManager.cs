...
namespace GKProcessor
{
	public static class DescriptorsManager
	{
		...
		{
			XManager.AutoGeneratedDelays = new List<XDelay>();
			XManager.AutoGeneratedPims = new List<XPim>();
