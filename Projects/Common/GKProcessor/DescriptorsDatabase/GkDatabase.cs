	...
	public class GkDatabase : CommonDatabase
	{
		...
		public override void BuildObjects()
		{
			...
			foreach (var door in Doors)
			{
				...
				//{
				//    var lockControlPim = new GKPim()
				//    {
				//        Name = door.PresentationName,
				//        IsAutoGenerated = true,
				//        DoorUID = door.UID
				//    };
				//    GKDeviceConfiguration.LinkGKBases(lockControlPim, door);
				//    GKDeviceConfiguration.LinkGKBases(lockControlPim, door.LockControlDevice);

				//    var lockControlPimDescriptor = new LockControlPimDescriptor(lockControlPim, DatabaseType.Gk, door);
				//    AddPim(lockControlPim);
				//    Descriptors.Add(lockControlPimDescriptor);
				//}
			}
