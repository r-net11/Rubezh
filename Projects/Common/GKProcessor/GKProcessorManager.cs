...
namespace GKProcessor
{
	public static class GKProcessorManager
	{
		...
		public static void AddGKMessage(JournalEventNameType journalEventNameType, JournalEventDescriptionType journalEventDescriptionType, string description, XBase xBase, string userName)
		{
			Guid uid = Guid.Empty;
