...
namespace RubezhAPI.GK
{
	...
	public class GKDevice : GKBase, IPlanPresentable
	{
		...
		[XmlIgnore]
		public GKPim DetectorDevicesMirrorPim { get; private set; }
		...
		public GKDevice()
		{
			...
			DetectorDevicesMirrorPim = new GKPim
			{
		...
		public override string PresentationName
		{
			get
			{
				...
				if (DetectorDevicesMirrorPim != null && DriverType == GKDriverType.RSR2_GKMirrorDetectorsDevice)
					DetectorDevicesMirrorPim.Name = result + " (УИЗВ)";
				return result;
			}
		}
