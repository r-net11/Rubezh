...
namespace RubezhAPI.GK
{
	...
	public class GKDoor : GKBase, IPlanPresentable
	{
		public GKDoor()
		{
			...
			OpenExitRegimeLogic = new GKLogic();
		...
		public override void Invalidate(GKDeviceConfiguration deviceConfiguration)
		{
			...
			OpenExitRegimeLogic.GetObjects().ForEach(AddDependentElement);
			...
			if (DoorType == GKDoorType.Turnstile)
			{
				ResetDevice = InvalidateDoorDevice(ResetDeviceUID, deviceConfiguration);
				ResetDeviceUID = ResetDevice != null ? ResetDevice.UID : Guid.Empty;
			}
		}
		...
		public override void UpdateLogic(GKDeviceConfiguration deviceConfiguration)
		{
			...
			deviceConfiguration.InvalidateOneLogic(this, OpenExitRegimeLogic);
		...
		public override string PresentationName
		{
			get
			{
				...
				if (LockDelay != null)
					LockDelay.Name = presentationName + " (задержка реле на вход)";
				if (LockDelayExit != null)
					LockDelayExit.Name = presentationName + " (задержка реле на выход)";
				if (ResetDelay != null)
					ResetDelay.Name = presentationName + " (задержка реле на сброс)";
		...
		[XmlIgnore]
		public GKDevice ResetDevice { get; set; }
		[XmlIgnore]
		public GKDelay LockDelay { get; set; }
		[XmlIgnore]
		public GKDelay LockDelayExit { get; set; }
		[XmlIgnore]
		public GKDelay ResetDelay { get; set; }
		[XmlIgnore]
		...
		/// <summary>
		/// Идентификатор устройства Сброс
		/// </summary>
		[DataMember]
		public Guid ResetDeviceUID { get; set; }
		...
		/// <summary>
		/// Логика перевода ТД в состояние Всегда Открыто (на вход)
		/// </summary>
		[DataMember]
		public GKLogic OpenRegimeLogic { get; set; }

		/// <summary>
		/// Логика перевода ТД в состояние Всегда Открыто (на выход)
		/// </summary>
		[DataMember]
		public GKLogic OpenExitRegimeLogic { get; set; }
