...
END
GO
IF NOT EXISTS (SELECT * FROM Patches WHERE Id = 'LicenseInfoAdded')
BEGIN
	IF NOT EXISTS (SELECT table_name FROM INFORMATION_SCHEMA.TABLES WHERE table_name = 'LicenseInfo')
	...
	INSERT INTO Patches (Id) VALUES ('LicenseInfoAdded')
END
GO
