...
END
GO
IF NOT EXISTS (SELECT * FROM Patches WHERE Id = 'TestAAA')
BEGIN
	INSERT INTO Patches (Id) VALUES ('TestAAA')	
END
GO
IF NOT EXISTS (SELECT * FROM Patches WHERE Id = 'TestBBB')
BEGIN
	INSERT INTO Patches (Id) VALUES ('TestBBB')	
END
GO
IF NOT EXISTS (SELECT * FROM Patches WHERE Id = 'TestCCC')
BEGIN
	INSERT INTO Patches (Id) VALUES ('TestCCC')	
END