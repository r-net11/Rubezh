...
EXEC [dbo].[SaveScheduleScheme] @GuardScheduleSchemeUid, @Organisation1Uid, 'Охрана', 1
SET @Uid = NEWID(); 
...
EXEC [dbo].[SaveScheduleScheme] @MontageScheduleSchemeUid, @Organisation1Uid, 'Монтаж', 2
SET @Uid = NEWID(); 
...
EXEC [dbo].[SaveScheduleScheme] @WeeklyScheduleSchemeUid, @Organisation1Uid, 'Пятидневка', 4
SET @Uid = NEWID(); 
...
SET @Uid = NEWID();
EXEC [dbo].[SavePassword] @Uid , @Organisation1Uid, 'Пароль1', '123',0,'01/01/1900'
SET @Uid = NEWID();
EXEC [dbo].[SavePassword] @Uid , @Organisation1Uid, 'Пароль2', '456',0,'01/01/1900'
...
SET @Uid = NEWID();
EXEC [dbo].[SavePassword] @Uid , @Organisation2Uid, 'Пароль3', '789',0,'01/01/1900'
SET @Uid = NEWID();
EXEC [dbo].[SavePassword] @Uid , @Organisation2Uid, 'Пароль3', '123456',0,'01/01/1900'
