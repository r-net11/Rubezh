...
namespace Commom.GK
{
    public static class KAUHelper
    {
        public static XDriver Create()
        {
            ...
            xDriver.AutoCreateChildren.Add(GKDriversHelper.KAUIndicator_UID);
            foreach (var driver in XManager.DriversConfiguration.Drivers)
            {
                var driverHelperItem = GKDriversHelper.Drivers.FirstOrDefault(x => x.XDriverType == driver.DriverType);
