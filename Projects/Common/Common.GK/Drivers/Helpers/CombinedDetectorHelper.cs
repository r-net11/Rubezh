...
namespace Common.GK
{
	public class CombinedDetectorHelper
	{
		public static void Create()
		{
			...
			CommonHelper.AddIntProprety(xDriver, 0x8B, "Порог срабатывания по температуре", 0, 100, 0, 85);
			CommonHelper.AddIntProprety(xDriver, 0x8C, "Порог срабатывания по градиенту температуры", 0, 100, 0, 255);
		}
	}
}