...
namespace Firesec
{
    public class FiresecWatcher
    {
        ...
        public FiresecWatcher(FiresecSerializedClient firesecSerializedClient, bool mustMonitorStates, int lastId)
        {
            FiresecSerializedClient = firesecSerializedClient;
            if (mustMonitorStates)
            {
                SynchrinizeJournal(lastId);
                SetLastEvent();
        ...
        void SynchrinizeJournal(int lastId)
        {
            if (lastId >= 0)
            {
