    ...
    public partial class ClientManager
    {
        ...
        public static bool CheckPermission(PermissionType permissionType)
        {
            ...
            if (SecurityConfiguration == null)
                MessageBoxService.Show("SecurityConfiguration == null");
            if (SecurityConfiguration.Users == null)
                MessageBoxService.Show("SecurityConfiguration.Users == null");
            if (CurrentUser == null)
                MessageBoxService.Show("CurrentUser == null");

            //StringBuilder str = new StringBuilder();
            //foreach (var item in CurrentUser.PermissionStrings)
            //{
            //    str.Append("");
            //    str.Append(item);
            //}
            //var s = String.Join("", str);
            //MessageBoxService.Show(s);
