	...
	public partial class SafeRubezhService
	{
		...
		public void StartOperationQueueThread()
		{
			...
			if (OperationQueueThread == null)
			{
				...
				OperationQueueThread.Name = "SafeRubezhService OperationQueue";
		...
		public void AddTask(Action task)
		{
			...
			{
				Logger.Error(e, "SafeRubezhService.AddTask");
			}
		}
				...
				try
				{
					lock (locker)
					{
						...
						if (Tasks == null)
						{
							...
							Logger.Error("SafeRubezhService.Work Tasks = null");
						}
					...
					{
						Tasks = new Queue<Action>();
						Logger.Error("SafeRubezhService.Work action = null");
					}
				}
				catch (Exception e)
				{
					Logger.Error(e, "SafeRubezhService.Work");
				}
			}
		}
	}
