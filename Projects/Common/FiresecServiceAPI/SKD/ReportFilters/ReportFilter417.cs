...
{
    [DataContract]
    public class ReportFilter417 : SKDReportFilter, IReportFilterOrganisation, IReportFilterDepartment, IReportFilterPosition, IReportFilterEmployeeAndVisitor, IReportFilterZone
    {
        public ReportFilter417()
        {
