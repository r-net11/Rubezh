...
{
	[DataContract]
	public class ReportFilter422 : SKDReportFilter, IReportFilterOrganisation, IReportFilterDepartment, IReportFilterPosition, IReportFilterEmployee, IReportFilterScheduleScheme
	{
