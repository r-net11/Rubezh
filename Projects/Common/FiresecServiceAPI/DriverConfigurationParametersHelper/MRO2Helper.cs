	...
	public class MRO2Helper
	{
		public static void Create(List<Driver> drivers)
		{
			...
			if (driver != null)
			{
				...
				ConfigurationDriverHelper.AddIntProprety(driver, 0x83, "Сообщений в памяти", "Сообщений в памяти", 0, 1, 0, 255);
				ConfigurationDriverHelper.AddIntProprety(driver, 0x84, "Сопротивление выходной линии, Ом", "Сопротивление выходной линии, Ом", 0, 0, 0, 255);
				ConfigurationDriverHelper.AddPlainEnumProprety(driver, 0x87, "Режим работы", 0, "Ведомый", "Ведущий", 0, 0, 0, false, false, "1");
