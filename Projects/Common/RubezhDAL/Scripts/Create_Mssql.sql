...
--DROP DATABASE "SKD";
--use "SKD1"
DECLARE @IsPostgres int;
SET @IsPostgres = 0;

CREATE TABLE "Photo"(
	"UID" uniqueidentifier CONSTRAINT "PK_Photo" PRIMARY KEY,
...
CREATE TABLE "Organisation"(
	"UID" uniqueidentifier CONSTRAINT "PK_Organisation" PRIMARY KEY,
	"ChiefUID" uniqueidentifier,
	"HRChiefUID" uniqueidentifier,
	"PhotoUID" uniqueidentifier,
...
CREATE TABLE "Employee"(
	...
	"Phone" character varying(50),
	"Description" character varying(4000),
	"LastEmployeeDayUpdate" datetime NOT NULL,
	"ExternalKey" character varying(40)
 );
...
CREATE TABLE "AdditionalColumnType"(
	"UID" uniqueidentifier CONSTRAINT "PK_AdditionalColumnType" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"IsDeleted" bit NOT NULL,
	"RemovalDate" datetime,
	"Name" character varying(50),
...
CREATE TABLE "AdditionalColumn"(
	"UID" uniqueidentifier CONSTRAINT "PK_AdditionalColumn" PRIMARY KEY,
	"EmployeeUID" uniqueidentifier,
	"AdditionalColumnTypeUID" uniqueidentifier,
	"PhotoUID" uniqueidentifier,
	"TextData" text
);
...
CREATE TABLE "ScheduleDay"(
	"UID" uniqueidentifier CONSTRAINT "PK_ScheduleDay" PRIMARY KEY,
	"DayIntervalUID" uniqueidentifier,
...
CREATE TABLE "DayIntervalPart"(
	"UID" uniqueidentifier CONSTRAINT "PK_DayIntervalPart" PRIMARY KEY,
	"DayIntervalUID" uniqueidentifier,
...
CREATE TABLE "DayInterval"(
	"UID" uniqueidentifier CONSTRAINT "PK_DayInterval" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
...
CREATE TABLE "Schedule"(
	"UID" uniqueidentifier CONSTRAINT "PK_Schedule" PRIMARY KEY,
	"ScheduleSchemeUID" uniqueidentifier,
	"OrganisationUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
...
CREATE TABLE "ScheduleScheme"(
	"UID" uniqueidentifier CONSTRAINT "PK_ScheduleScheme" PRIMARY KEY,	
	"OrganisationUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
	"Type" int NOT NULL,
...
CREATE TABLE "Position"(
	"UID" uniqueidentifier CONSTRAINT "PK_Position" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"PhotoUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
...
CREATE TABLE "Department"(
	"UID" uniqueidentifier CONSTRAINT "PK_Department" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"PhotoUID" uniqueidentifier,
	"ParentDepartmentUID" uniqueidentifier,
	"ChiefUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
	"IsDeleted" bit NOT NULL,
...
CREATE TABLE "Holiday"(
	"UID" uniqueidentifier CONSTRAINT "PK_Holiday" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
	"Type" int NOT NULL,
...
CREATE TABLE "Card"(
	"UID" uniqueidentifier CONSTRAINT "PK_Card" PRIMARY KEY,
	"EmployeeUID" uniqueidentifier,
	"AccessTemplateUID" uniqueidentifier,
	"PassCardTemplateUID" uniqueidentifier,
	"Number" int NOT NULL,
	...
	"DeactivationControllerUID" uniqueidentifier NOT NULL,
...
CREATE TABLE "PendingCard"(
	"UID" uniqueidentifier CONSTRAINT "PK_PendingCard" PRIMARY KEY,
	"CardUID" uniqueidentifier,
...
CREATE TABLE "CardDoor"(
	"UID" uniqueidentifier CONSTRAINT "PK_CardDoor" PRIMARY KEY,
	"CardUID" uniqueidentifier,
	"AccessTemplateUID" uniqueidentifier,
...
CREATE TABLE "AccessTemplate"(
	"UID" uniqueidentifier CONSTRAINT "PK_AccessTemplate" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
	"IsDeleted" bit NOT NULL,
...
CREATE TABLE "ScheduleZone"(
	"UID" uniqueidentifier CONSTRAINT "PK_ScheduleZone" PRIMARY KEY,
	"ScheduleUID" uniqueidentifier,
...
CREATE TABLE "TimeTrackDocument"(
	"UID" uniqueidentifier CONSTRAINT "PK_TimeTrackDocument" PRIMARY KEY,
	"EmployeeUID" uniqueidentifier,
...
CREATE TABLE "PassCardTemplate"(
	"UID" uniqueidentifier CONSTRAINT "PK_PassCardTemplate" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"Name" character varying(50),
	"Description" character varying(4000),
	"IsDeleted" bit NOT NULL,
...
CREATE TABLE "OrganisationUser"(
	"UID" uniqueidentifier CONSTRAINT "PK_OrganisationUser" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
...
CREATE TABLE "OrganisationDoor"(
	"UID" uniqueidentifier CONSTRAINT "PK_OrganisationDoor" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
	"DoorUID" uniqueidentifier NOT NULL
);
...
CREATE TABLE "NightSetting"(
	"UID" uniqueidentifier CONSTRAINT "PK_NightSetting" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
...
CREATE TABLE "TimeTrackDocumentType"(
	"UID" uniqueidentifier CONSTRAINT "PK_TimeTrackDocumentType" PRIMARY KEY,
	"OrganisationUID" uniqueidentifier,
...
CREATE TABLE "TimeTrackException"(
	"UID" uniqueidentifier CONSTRAINT "PK_TimeTrackException" PRIMARY KEY,
	"EmployeeUID" uniqueidentifier,
	"StartDateTime" datetime NOT NULL,
	"EndDateTime" datetime NOT NULL,
	"DocumentType" int NOT NULL,
...
CREATE TABLE "GKMetadata"(
	"UID" uniqueidentifier CONSTRAINT "PK_GKMetadata" PRIMARY KEY,
...
CREATE TABLE "GKCard"(
	"UID" uniqueidentifier CONSTRAINT "PK_GKCard" PRIMARY KEY,
...
CREATE TABLE "GKSchedule"(
	"UID" uniqueidentifier CONSTRAINT "PK_GKSchedule" PRIMARY KEY,
	"No" int NOT NULL,
	"Name" character varying(50),
	"Description" character varying(50),
	"Type" int NOT NULL,
...
CREATE TABLE "GKScheduleDay"(
	"UID" uniqueidentifier CONSTRAINT "PK_GKScheduleDay" PRIMARY KEY,
	"ScheduleUID" uniqueidentifier,
...
CREATE TABLE "GKDaySchedule"(
	"UID" uniqueidentifier CONSTRAINT "PK_GKDaySchedule" PRIMARY KEY,
	"No" int NOT NULL,
	"Name" character varying(50),
	"Description" character varying(50)
);
...
CREATE TABLE "ScheduleGKDaySchedule"(
	"UID" uniqueidentifier  CONSTRAINT "PK_ScheduleGKDaySchedule" PRIMARY KEY,
	"ScheduleUID" uniqueidentifier,
	"DayScheduleUID" uniqueidentifier
);
CREATE INDEX "ScheduleGKDayScheduleScheduleUIDIndex" ON "ScheduleGKDaySchedule"("ScheduleUID");

CREATE TABLE "GKDaySchedulePart"(
	"UID" uniqueidentifier CONSTRAINT "PK_GKDaySchedulePart" PRIMARY KEY,
...
CREATE TABLE "CurrentConsumption"(
	"UID" uniqueidentifier CONSTRAINT "PK_CurrentConsumption" PRIMARY KEY,
	"AlsUID" uniqueidentifier NOT NULL,
...
CREATE TABLE "CardGKControllerUID"(
	"UID" uniqueidentifier CONSTRAINT "PK_CardGKControllerUID" PRIMARY KEY,
	"CardUID" uniqueidentifier,
...
CREATE TABLE "Journal"(
	"UID" uniqueidentifier CONSTRAINT "PK_Journal" PRIMARY KEY,
	"EmployeeUID" uniqueidentifier,
	...
	"VideoUID" uniqueidentifier,
	"CameraUID" uniqueidentifier,
	"CardNo" int NOT NULL
);
...
CREATE TABLE "PassJournal"(
	"UID" uniqueidentifier CONSTRAINT "PK_PassJournal" PRIMARY KEY,
	"EmployeeUID" uniqueidentifier,
	"ZoneUID" uniqueidentifier NOT NULL,
...
CREATE TABLE "EmployeeDay"(
	"UID" uniqueidentifier CONSTRAINT "PK_EmployeeDay" PRIMARY KEY,
	"EmployeeUID" uniqueidentifier,
	"IsIgnoreHoliday" bit NOT NULL,
	"IsOnlyFirstEnter" bit NOT NULL,
	"AllowedLate" int NOT NULL,
...
ALTER TABLE "Organisation" ADD CONSTRAINT "FK_Organisation_PhotoUID" FOREIGN KEY ("PhotoUID") REFERENCES "Photo" ("UID") ON DELETE SET NULL;
if(@IsPostgres = 1)
BEGIN
...
ELSE
BEGIN
	ALTER TABLE "Organisation" ADD CONSTRAINT "FK_Organisation_ChiefUID" FOREIGN KEY ("ChiefUID") REFERENCES "Employee" ("UID") ON DELETE NO ACTION;
	ALTER TABLE "Organisation" ADD CONSTRAINT "FK_Organisation_HRChiefUID" FOREIGN KEY ("HRChiefUID") REFERENCES "Employee" ("UID") ON DELETE NO ACTION;
END
...
ELSE
	ALTER TABLE "Employee" ADD CONSTRAINT "FK_Employee_EscortUID" FOREIGN KEY ("EscortUID") REFERENCES "Employee" ("UID") ON DELETE NO ACTION;
ALTER TABLE "Employee" ADD CONSTRAINT "FK_Employee_ScheduleUID" FOREIGN KEY ("ScheduleUID") REFERENCES "Schedule" ("UID") ON DELETE SET NULL;
...
ALTER TABLE "AdditionalColumn" ADD CONSTRAINT "FK_AdditionalColumn_PhotoUID" FOREIGN KEY ("PhotoUID") REFERENCES "Photo" ("UID") ON DELETE SET NULL;
...
ELSE
	ALTER TABLE "Department" ADD CONSTRAINT "FK_Department_ParentDepartmentUID" FOREIGN KEY ("ParentDepartmentUID") REFERENCES "Department" ("UID") ON DELETE NO ACTION;
...
--CREATE EXTENSION "uniqueidentifier-ossp";
--CREATE FUNCTION CreateOrganisation() RETURNS void AS $$
--DECLARE
--	OrgUID uniqueidentifier;
--BEGIN
--	OrgUID := uniqueidentifier_generate_v4();
--	INSERT INTO "Organisation" ("UID", "Name" ,"IsDeleted") VALUES (OrgUid,'Организация','0');
--	INSERT INTO "OrganisationUser" ("UID","UserUID","OrganisationUID") VALUES (uniqueidentifier_generate_v4(),'10e591fb-e017-442d-b176-f05756d984bb',OrgUid);
--END;
--$$ LANGUAGE plpgsql;
