...
insert into SecAct(IDSecAct, Name, Num, IDSecObjtype) values (19, 'ОЗ: Постановка, снятие зон с охраны', 19, 1);
insert into SecAct(IDSecAct, Name, Num, IDSecObjtype) values (20, 'ОЗ: Включение автоматики', 20, 1);
...
insert into grouprights(IDUserGroups, IDSecObj, IDSecAct) values(2, 1, 19);
insert into grouprights(IDUserGroups, IDSecObj, IDSecAct) values(2, 1, 20);
...
insert into grouprights(IDUserGroups, IDSecObj, IDSecAct) values(3, 1, 19);
insert into grouprights(IDUserGroups, IDSecObj, IDSecAct) values(3, 1, 20);
