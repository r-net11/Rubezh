...
namespace ReportsModule.ViewModels
{
    public class FilterMainPageViewModel : FilterContainerViewModel
    {
        ...
        public FilterMainPageViewModel(FilterModel model, SKDReportFilter filter, Action<SKDReportFilter> loadFilterAction, Action<SKDReportFilter> updateFilterAction)
        {
            ...
            var reportFilterResult = FiresecManager.FiresecService.GetReportFiltersByType(FiresecManager.CurrentUser, ((SKDReportFilter)Activator.CreateInstance(_filterType)).ReportType);
            Filters = reportFilterResult.HasError ? new ObservableCollection<SKDReportFilter>() : new ObservableCollection<SKDReportFilter>(reportFilterResult.Result);
