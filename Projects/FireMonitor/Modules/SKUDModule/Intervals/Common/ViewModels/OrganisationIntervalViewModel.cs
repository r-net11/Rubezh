...
{
	public abstract class OrganisationIntervalViewModel<TViewModel, TElement> : ViewPartViewModel, IEditingViewModel, ISelectable<Guid>
		...
		where TElement : OrganizationElementBase
	{
		...
		public OrganisationIntervalViewModel(Organisation organization)
		{
			Organization = organization;
		}

		public void Initialize(IEnumerable<TElement> models)
		{
