...
namespace GKModule
{
	public partial class GKModuleLoader : ModuleBase, IReportProviderModule, ILayoutProviderModule, ISKDReportProviderModule
	{
		...
		public override void Initialize()
		{
			...
			_zonesNavigationItem.IsVisible = LicenseManager.FiresecLicenseManager.CurrentLicenseInfo.HasFirefighting && GKManager.Zones.Count > 0;
			_guardZonesNavigationItem.IsVisible = LicenseManager.FiresecLicenseManager.CurrentLicenseInfo.HasGuard && GKManager.DeviceConfiguration.GuardZones.Count > 0;
			_skdZonesNavigationItem.IsVisible = LicenseManager.FiresecLicenseManager.CurrentLicenseInfo.HasSKD && GKManager.DeviceConfiguration.SKDZones.Count > 0;
			_directionsNavigationItem.IsVisible = GKManager.Directions.Count > 0;
			_pumpStationsNavigationItem.IsVisible = LicenseManager.FiresecLicenseManager.CurrentLicenseInfo.HasFirefighting && GKManager.PumpStations.Count > 0;
			_mptsNavigationItem.IsVisible = LicenseManager.FiresecLicenseManager.CurrentLicenseInfo.HasFirefighting && GKManager.MPTs.Count > 0;
			...
			_doorsNavigationItem.IsVisible = LicenseManager.FiresecLicenseManager.CurrentLicenseInfo.HasSKD && GKManager.Doors.Count > 0;
				...
				new NavigationItem(ModuleType.ToDescription(), "tree",
					new List<NavigationItem>()
					{
						...
						new NavigationItem("СКД", "tree", 
							...
							}){IsVisible = ClientManager.CheckPermission(PermissionType.Oper_ScheduleSKD) && LicenseManager.FiresecLicenseManager.CurrentLicenseInfo.HasSKD},
					})
			};
		}
