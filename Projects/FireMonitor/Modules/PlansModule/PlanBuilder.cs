...
namespace PlansModule
{
    public static class PlanLoader
    {
        ...
        static void CreateDemoData()
        {
            ...
            plan.ElementPolygonZones = new List<ElementPolygonZone>();
            plan.ElementPolygonZones.Add(new ElementPolygonZone());
            plan.ElementPolygonZones[0].ZoneNo = 0;
            //plan.ElementZones[0].PolygonPoints = new List<PolygonPoint>();
            plan.ElementPolygonZones[0].PolygonPoints = new PointCollection();
            plan.ElementPolygonZones[0].PolygonPoints.Add(new Point() { X = 300, Y = 300 });
            plan.ElementPolygonZones[0].PolygonPoints.Add(new Point() { X = 300, Y = 400 });
            plan.ElementPolygonZones[0].PolygonPoints.Add(new Point() { X = 400, Y = 400 });
            plan.ElementPolygonZones[0].PolygonPoints.Add(new Point() { X = 400, Y = 300 });
