...
namespace RubezhService.Service
{
	public static class NotifyIconService
	{
		...
		public static void Start(EventHandler onShow, EventHandler onClose)
		{
			...
			Stream iconStream = Application.GetResourceStream(new Uri("pack://application:,,,/RubezhService;component/Rubezh.ico")).Stream;
			...
			_notifyIcon.Text = "Сервер приложений Глобал";
		}
