...
namespace GKModule.ViewModels
{
	public class GuardZoneViewModel : BaseViewModel
	{
		...
		void OnTurnOn()
		{
			...
			{
				ClientManager.RubezhService.GKTurnOn(GuardZone);
			}
		}
		...
		void OnTurnOnNow()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOnNow(GuardZone);
			}
		}
		...
		void OnTurnOnInAutomatic()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				if (!State.StateClasses.Contains(XStateClass.AutoOff))
					ClientManager.RubezhService.GKTurnOnInAutomatic(GuardZone);
				else
					ClientManager.RubezhService.GKTurnOn(GuardZone);
			}
		}
		...
		void OnTurnOnNowInAutomatic()
		{
			...
			{
				if (!State.StateClasses.Contains(XStateClass.AutoOff))
					ClientManager.RubezhService.GKTurnOnNowInAutomatic(GuardZone);
				else
					ClientManager.RubezhService.GKTurnOnNow(GuardZone);
			}
		}
		...
		void OnTurnOff()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOff(GuardZone);
			}
		}
		...
		void OnTurnOffInAutomatic()
		{
			...
			{
				if (!State.StateClasses.Contains(XStateClass.AutoOff))
					ClientManager.RubezhService.GKTurnOffInAutomatic(GuardZone);
				else
					ClientManager.RubezhService.GKTurnOff(GuardZone);
			}
		}
		...
		void OnTurnOffNowInAutomatic()
		{
			...
			{
				if (!State.StateClasses.Contains(XStateClass.AutoOff))
					ClientManager.RubezhService.GKTurnOffNowInAutomatic(GuardZone);
				else
					ClientManager.RubezhService.GKTurnOffNow(GuardZone);
			}
		}
