...
namespace GKModule.ViewModels
{
	public class DoorDetailsViewModel : DialogViewModel, IWindowIdentity
	{
		...
		void OnSetManualState()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKSetManualRegime(Door);
			}
		}
		...
		void OnSetIgnoreState()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKSetIgnoreRegime(Door);
			}
		}
		...
		void OnTurnOn()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOn(Door);
			}
		}
		...
		void OnTurnOff()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOff(Door);
			}
		}
		...
		void OnTurnOffNow()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOffNow(Door);
			}
		}
		...
		void OnSetRegimeNorm()
		{
			...
			{
				ClientManager.RubezhService.GKSetAutomaticRegime(Door);
				ClientManager.RubezhService.GKTurnOffInAutomatic(Door);
			}
		}
