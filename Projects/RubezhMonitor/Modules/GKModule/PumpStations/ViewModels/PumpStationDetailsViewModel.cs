...
namespace GKModule.ViewModels
{
	public class PumpStationDetailsViewModel : DialogViewModel, IWindowIdentity
	{
		...
		void OnSetManualState()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKSetManualRegime(PumpStation);
			}
		}
		...
		void OnSetIgnoreState()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKSetIgnoreRegime(PumpStation);
			}
		}
		...
		void OnTurnOn()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOn(PumpStation);
			}
		}
		...
		void OnTurnOnNow()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOnNow(PumpStation);
			}
		}
		...
		void OnTurnOff()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOff(PumpStation);
			}
		}
		...
		void OnForbidStart()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKStop(PumpStation);
			}
		}
