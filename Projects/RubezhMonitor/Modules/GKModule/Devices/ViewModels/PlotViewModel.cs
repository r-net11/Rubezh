...
namespace GKModule.ViewModels
{
	class PlotViewModel : DialogViewModel
	{
		...
		{
			var measuresResult = ClientManager.RubezhService.GetAlsMeasure(DeviceUid);
		...
		{
			CurrentConsumptions = new List<CurrentConsumption>();
			var measuresResult = ClientManager.RubezhService.GetCurrentConsumption(new CurrentConsumptionFilter
			{
				AlsUID = DeviceUid,
