...
namespace GKModule.ViewModels
{
	public class SKDZoneViewModel : BaseViewModel
	{
		...
		{
			if (ShowOnPlanHelper.ShowObjectOnPlan(SKDZone))
		...
		{
			ShowOnPlanHelper.ShowObjectOnPlan(SKDZone);
		}
		public bool CanShowOnPlan()
		{
			return ShowOnPlanHelper.CanShowOnPlan(SKDZone);
		}
		...
		void OnOpen()
		{
			...
			{
				ClientManager.RubezhService.GKOpenSKDZone(SKDZone);
			}
		}
		...
		void OnClose()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKCloseSKDZone(SKDZone);
			}
		}
