...
namespace GKModule
{
	public partial class GKModuleLoader
	{
		...
		{
			SafeRubezhService.GKProgressCallbackEvent -= new Action<GKProgressCallback>(OnGKProgressCallbackEvent);
			SafeRubezhService.GKProgressCallbackEvent += new Action<GKProgressCallback>(OnGKProgressCallbackEvent);

			SafeRubezhService.GKCallbackResultEvent -= new Action<GKCallbackResult>(OnGKCallbackResult);
			SafeRubezhService.GKCallbackResultEvent += new Action<GKCallbackResult>(OnGKCallbackResult);

			SafeRubezhService.GKPropertyChangedEvent -= new Action<GKPropertyChangedCallback>(OnGKPropertyChanged);
			SafeRubezhService.GKPropertyChangedEvent += new Action<GKPropertyChangedCallback>(OnGKPropertyChanged);
