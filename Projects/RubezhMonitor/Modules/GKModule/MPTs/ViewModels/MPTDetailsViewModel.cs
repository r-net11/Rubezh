...
namespace GKModule.ViewModels
{
	public class MPTDetailsViewModel : DialogViewModel, IWindowIdentity
	{
		...
		void OnSetManualState()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKSetManualRegime(MPT);
			}
		}
		...
		void OnSetIgnoreState()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKSetIgnoreRegime(MPT);
			}
		}
		...
		void OnTurnOn()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOn(MPT);
			}
		}
		...
		void OnTurnOnNow()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOnNow(MPT);
			}
		}
		...
		void OnTurnOff()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKTurnOff(MPT);
			}
		}
		...
		void OnForbidStart()
		{
			if (ServiceFactory.SecurityService.Validate())
			{
				ClientManager.RubezhService.GKStop(MPT);
			}
		}
