(function() {
    'use strict';
    var app = angular.module('gkApp', ['gkApp.controllers', 'gkApp.directives', 'gkApp.services', 'ui.bootstrap', 'ui.grid', 'ui.grid.treeView', 'ui.grid.autoResize', 'ui.grid.selection', 'ui.tree']);
