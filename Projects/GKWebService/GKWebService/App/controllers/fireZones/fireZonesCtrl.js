	...
	var app = angular.module('gkApp.controllers').controller('fireZonesCtrl',
        ...
        function ($scope, $http, $timeout, $uibModal, $stateParams, uiGridConstants, signalrFireZonesService, broadcastService, dialogService, constants) {
        	...
        	$scope.gridOptions = {
        		...
        		columnDefs: [
                    { field: 'No', enableColumnResizing: true, displayName: '№', width: 60, cellTemplate: '<div class="ui-grid-cell-contents"><img style="vertical-align: middle; padding-right: 3px" ng-src="/Content/Image/{{row.entity.ImageSource}}"/>{{row.entity[col.field]}}</div>' },
