...
namespace GKModule.ViewModels
{
	public class GKUsersViewModel : DialogViewModel
	{
		...
		public GKUsersViewModel(List<GKUser> deviceUsers, Guid deviceUID)
		{
			...
			var getDbUsersResult = ClientManager.RubezhService.GetDbDeviceUsers(deviceUID, deviceDoorUIDs);
		...
		void OnRewriteUsers()
		{
			var result = ClientManager.RubezhService.GKRewriteUsers(_deviceUID);
			if (result.HasError)
			{
