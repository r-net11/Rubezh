...
namespace GKModule.ViewModels
{
	public class DirectionDetailsViewModel : SaveCancelDialogViewModel
	{
		...
		void OnReadProperties()
		{
			...
			var result = ClientManager.RubezhService.GKGetSingleParameter(Direction);
		...
		void OnWriteProperties()
		{
			...
			{
				var result = ClientManager.RubezhService.GKSetSingleParameter(Direction, baseDescriptor.Parameters);
				if (result.HasError)
				{
					MessageBoxService.ShowError(result.Error);
				}
		...
		bool CompareLocalWithRemoteHashes()
		{
			...
			var result = ClientManager.RubezhService.GKGKHash(Direction.GkDatabaseParent);
			if (result.HasError)
			{
