...
namespace GKModule.ViewModels
{
	public class PumpStationDetailsViewModel : SaveCancelDialogViewModel
	{
		...
		void OnReadProperties()
		{
			...
			var result = ClientManager.RubezhService.GKGetSingleParameter(PumpStation);
		...
		void OnWriteProperties()
		{
			...
			{
				var result = ClientManager.RubezhService.GKSetSingleParameter(PumpStation, baseDescriptor.Parameters);
				if (result.HasError)
				{
					MessageBoxService.ShowError(result.Error);
				}
		...
		bool CompareLocalWithRemoteHashes()
		{
			...
			var result = ClientManager.RubezhService.GKGKHash(PumpStation.GkDatabaseParent);
			if (result.HasError)
			{
