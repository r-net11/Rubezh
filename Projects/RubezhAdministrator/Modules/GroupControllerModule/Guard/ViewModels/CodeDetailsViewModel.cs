...
namespace GKModule.ViewModels
{
	public class CodeDetailsViewModel : SaveCancelDialogViewModel
	{
		...
		void OnReadProperties()
		{
			...
			var result = ClientManager.RubezhService.GKGetSingleParameter(Code);
		...
		void OnWriteProperties()
		{
			...
			{
				var result = ClientManager.RubezhService.GKSetSingleParameter(Code, baseDescriptor.Parameters);
				if (result.HasError)
				{
					MessageBoxService.ShowError(result.Error);
				}
		...
		bool CompareLocalWithRemoteHashes()
		{
			...
			var result = ClientManager.RubezhService.GKGKHash(Code.GkDatabaseParent);
			if (result.HasError)
			{
