...
namespace FireAdministrator.ViewModels
{
	public class MergeConfigurationHelper
	{
		...
		public void LoadFromZipFile(string fileName)
		{
			...
			{
				Logger.Error("RubezhManager.LoadFromZipFile zipConfigurationItemsCollectionFileName file not found");
				return;
			}
			...
			{
				Logger.Error("RubezhManager.LoadFromZipFile zipConfigurationItemsCollection == null");
				return;
			}
