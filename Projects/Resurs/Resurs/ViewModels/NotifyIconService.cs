...
namespace Resurs.Service
{
	public static class NotifyIconService
	{
		...
		public static void Start(EventHandler onShow, EventHandler onClose)
		{
			...
			Stream iconStream = Application.GetResourceStream(new Uri("pack://application:,,,/Resurs;component/Resurs.ico")).Stream;
