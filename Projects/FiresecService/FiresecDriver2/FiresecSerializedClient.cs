...
namespace FiresecDriver
{
	public class FiresecSerializedClient
	{
		...
		public FiresecOperationResult<FiresecDriver2.XSD.functions> DeviceCustomFunctionList(string driverUID)
		{
			var result = NativeFiresecClient.DeviceCustomFunctionList(driverUID);
			return ConvertResultData<FiresecDriver2.XSD.functions>(result);
		}
