...
namespace StrazhService.Monitor.Database
{
	public class MsSqlServerDatabaseService : IDatabaseService
	{
		...
		public bool CheckConnection(string ipAddress, int ipPort, bool useIntegratedSecurity, string userID, string userPwd, out string errors)
		{
			errors = null;
		...
		public bool CreateBackup(string ipAddress, int ipPort, bool useIntegratedSecurity, string userID,
