...
namespace FiresecService.Report.Templates
{
	partial class EmployeeDoorsReport
	{
		...
		private void InitializeComponent()
		{
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "Data.AccessSchedule")});
			...
			this.xrTableCell1.Text = "Access point";
			...
			this.xrTableCell2.Text = "from the zone";
			...
			this.xrTableCell3.Text = "In the zone";
			...
			this.xrTableCell4.Text = "access Schedule";
			...
			this.xrTableCell5.Text = "pass type";
			...
			this.xrTableCell6.Text = "Number of passes";
			...
			this.xrTableCell8.Text = "Organization";
			...
			this.xrTableCell9.Text = "Subdivision";
			...
			this.xrTableCell10.Text = "Position";
