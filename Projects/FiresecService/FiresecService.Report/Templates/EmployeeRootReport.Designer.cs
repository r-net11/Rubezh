namespace FiresecService.Report.Templates
{
	partial class EmployeeRootReport
	{
		...
		private void InitializeComponent()
		{
			...
			//this.xrTableCell2.Weight = 0.23D;
			// 
			// xrTableCell3
			// 
			...
			//this.xrTableCell4.Weight = 0.19D;
			// 
			// GroupHeader1
			// 
			...
			//this.xrTableCell6.Text = "Точка доступа";
			//this.xrTableCell6.Weight = 0.23D;
			// 
			// xrTableCell7
			// 
			...
			//this.xrTableCell8.Text = "Пропуск";
			//this.xrTableCell8.Weight = 0.19D;
			// 
			// xrControlStyle1
			// 
