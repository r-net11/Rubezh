namespace FiresecService.Report.Templates
{
	partial class EventsReport
	{
		...
		private void InitializeComponent()
		{
			...
			this.xrTableCell8.Text = "Date and time of the system";
			...
			this.xrTableCell9.Text = "The date and time on your device";
			...
			this.xrTableCell10.Text = typeof(Localization.FiresecService.Report.Common.CommonResources).Name;
			...
			this.xrTableCell11.Text = "elaboration";
			...
			this.xrTableCell12.Text = "An object";
			...
			this.xrTableCell14.Text = "Subsystem";
			...
			xrSummary1.FormatString = "Total events: {0}";
