	...
	public class Watcher
	{
        ...
        public Watcher(FiresecSerializedClient firesecSerializedClient, bool mustMonitorStates, bool mustMonitorJournal)
		{
            ...
            if (mustMonitorStates)
            {
				...
				firesecSerializedClient.NativeFiresecClient.StateChanged += new Action<Firesec.Models.CoreState.config>(OnStateChanged);
                firesecSerializedClient.NativeFiresecClient.ParametersChanged += new Action<Firesec.Models.DeviceParameters.config>(OnParametersChanged);
			}
