...
namespace ServerFS2
{
	public static class ServerHelper
	{
		...
		private static OperationResult<List<Response>> SendCode(List<List<byte>> bytesList, int delay = 1000, int timeout = 1000)
		{
			return UsbRunner.AddRequest(bytesList, delay, timeout);
		}

		private static OperationResult<List<Response>> SendCode(List<byte> bytes, int delay = 1000, int timeout = 1000)
		{
