...
namespace ServerFS2
{
	public static class DriversHelper
	{
		public class DriverData
		{
			...
			public byte DriverCode { get; private set; }
		...
		static DriversHelper()
		{
			...
			DriverDataList.Add(new DriverData("B476541B-5298-4B3E-A9BA-605B839B1011", "Прибор Рубеж-2AM", 1, DriverType.Rubezh_2AM));
			DriverDataList.Add(new DriverData("02CE2CC4-D71F-4EAA-ACCC-4F2E870F548C", "БУНС", 2, DriverType.BUNS));
			DriverDataList.Add(new DriverData("F966D47B-468D-40A5-ACA7-9BE30D0A3847", "Модуль сопряжения МС-3", 100, DriverType.MS_3));
			DriverDataList.Add(new DriverData("F966D47B-468D-40A5-ACA7-9BE30D0A3847", "Модуль сопряжения МС-4", 101, DriverType.MS_4));
			DriverDataList.Add(new DriverData("584BC59A-28D5-430B-90BF-592E40E843A6", "Модуль сопряжения МС-ТЛ", 102, DriverType.UOO_TL));
			DriverDataList.Add(new DriverData("28A7487A-BA32-486C-9955-E251AF2E9DD4", "Блок индикации БИ", 3, DriverType.IndicationBlock));
			DriverDataList.Add(new DriverData("E750EF8F-54C3-4B00-8C72-C7BEC9E59BFC", "Прибор Рубеж-10AM", 4, DriverType.Rubezh_10AM));
