	...
	public class JournalParser
	{
		public static FSJournalItem FSParce(List<byte> allbytes)
		{
			...
			if (_fsjournalItem.DeviceCategory != 0)
			{
				...
				{
					var v = MetadataHelper.Metadata.deviceTables.FirstOrDefault(x => ((x.deviceDriverID != null) && (x.deviceDriverID.Equals(deviceUid))));
		...
		private static string GetEvent(string eventName, int flag)
		{
