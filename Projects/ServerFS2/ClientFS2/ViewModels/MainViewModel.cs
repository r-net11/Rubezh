...
namespace ClientFS2.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        {
            MainManager.ResetFire(DevicesViewModel.SelectedDevice.Device);
        }
        ...
        private void OnResetTest()
        {
            ...
            if (Status == null)
                return;
            MainManager.ResetTest(DevicesViewModel.SelectedDevice.Device, Status);
        }

        public RelayCommand GetDeviceStatusCommand { get; private set; }
        void OnGetDeviceStatus()
        {
            Status = MainManager.GetDeviceStatus(DevicesViewModel.SelectedDevice.Device);
        }
        ...
        {
            MainManager.AddDeviceToCheckList(DevicesViewModel.SelectedDevice.Device);
        }
        ...
        {
            MainManager.RemoveDeviceFromCheckList(DevicesViewModel.SelectedDevice.Device);
        }
