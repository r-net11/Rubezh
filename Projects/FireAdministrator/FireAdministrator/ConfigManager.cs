	...
	public static class ConfigManager
	{
		...
		public static string SaveAllConfigToFile(bool saveAnyway = false)
		{
			try
			{
				...
				if (ServiceFactory.SaveService.InstructionsChanged || ServiceFactory.SaveService.SoundsChanged || ServiceFactory.SaveService.FilterChanged || ServiceFactory.SaveService.AutomationSoundsChanged || ServiceFactory.SaveService.CamerasChanged || ServiceFactory.SaveService.EmailsChanged || ServiceFactory.SaveService.AutomationChanged || saveAnyway)
