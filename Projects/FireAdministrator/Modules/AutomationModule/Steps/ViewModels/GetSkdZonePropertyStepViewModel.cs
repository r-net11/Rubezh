...
{
	public class GetSkdZonePropertyStepViewModel: BaseStepViewModel
	{
		...
		public GetSkdZonePropertyStepViewModel(StepViewModel stepViewModel)
			: base(stepViewModel)
		{
			...
			SelectedObjectType = ObjectType.SKDZone;
		}		
		...
		public override string Description
		{
			get 
			{ 
				return string.Format("Зона: {0} Свойство: {1} Значение: {2}",ObjectArgument.Description, SelectedProperty.ToDescription(), ResultArgument.Description); 
			}
		}
