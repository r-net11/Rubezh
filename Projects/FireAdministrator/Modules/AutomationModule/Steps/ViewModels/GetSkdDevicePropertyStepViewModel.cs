...
{
	public class GetSkdDevicePropertyStepViewModel: BaseStepViewModel
	{
		...
		public GetSkdDevicePropertyStepViewModel(StepViewModel stepViewModel)
			: base(stepViewModel)
		{
			...
			SelectedObjectType = ObjectType.SKDDevice;
		}		
		...
		public override string Description
		{
			get 
			{ 
				return string.Format("Устройство: {0} Свойство: {1} Значение: {2}",ObjectArgument.Description, SelectedProperty.ToDescription(), ResultArgument.Description); 
			}
		}
