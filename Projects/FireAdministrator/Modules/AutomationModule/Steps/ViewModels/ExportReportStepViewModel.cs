...
namespace AutomationModule.ViewModels
{
    public class ExportReportStepViewModel : BaseStepViewModel
    {
            ...
            : base(stepViewModel)
        {
            ...
            var allFiltersResult = FiresecManager.FiresecService.GetAllFilters();
            CachedFilters = allFiltersResult.HasError ? new List<SKDReportFilter>() : allFiltersResult.Result;
