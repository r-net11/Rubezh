...
namespace AutomationModule.ViewModels
{
	public class StepTypeSelectationViewModel : SaveCancelDialogViewModel
	{
		...
		{
			Title = stepTypeSelectionViewModel.Title;
		...
		private void BuildStepTypeTree()
		{
			...
			RootStepType = new StepTypeViewModel(stepTypeSelectionViewModel.FunctionsRegister, "/Controls;component/Images/CFolder.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildDataExchangeNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.DataExchange, "/Controls;component/StepIcons/Export.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildOperationsNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.Operations, "/Controls;component/StepIcons/Arithmetics.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildInteractiveLogicNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.Logic, "/Controls;component/StepIcons/PlaySound.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildServiceFunctionsNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.ServiceFunctions, "/Controls;component/StepIcons/Exit.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildSeriesFunctionsNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.CycleFunctions, "/Controls;component/StepIcons/For.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildHardwareControlNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.HardwareControl, "/Controls;component/StepIcons/Control.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildStrazhControlNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.StrazhControl, "/Controls;component/StepIcons/Control.png", stepTypeViewModels);
		}
		...
		private StepTypeViewModel BuildVideoControlNode()
		{
			...
			return new StepTypeViewModel(stepTypeSelectionViewModel.VideoControl, "/Controls;component/StepIcons/Control.png", stepTypeViewModels);
		}
