...
namespace GKModule.ViewModels
{
	public class XLibraryViewModel : ViewPartViewModel
	{
		public XLibraryViewModel()
		{
			...
			var devices = from LibraryXDevice libraryXDevice in XManager.XDeviceLibraryConfiguration.XDevices orderby libraryXDevice.XDriver.DeviceClassName select libraryXDevice;
			XDevices = new ObservableCollection<XDeviceViewModel>();
			foreach (var device in devices)
			{
				var deviceViewModel = new XDeviceViewModel(device);
				XDevices.Add(deviceViewModel);
			}
