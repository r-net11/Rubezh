...
namespace SKDModule.ViewModels
{
	public class FiltersViewModel : MenuViewPartViewModel, IEditingViewModel
	{
		...
		{
			JournalFilters = SKDManager.SKDConfiguration.SKDSystemConfiguration.JournalFilters == null ? new ObservableCollection<FilterViewModel>() : new ObservableCollection<FilterViewModel>(
				from journalFilter in SKDManager.SKDConfiguration.SKDSystemConfiguration.JournalFilters
		...
		void OnDelete()
		{
			...
			{
				SKDManager.SKDConfiguration.SKDSystemConfiguration.JournalFilters.Remove(SelectedJournalFilter.JournalFilter);
