	...
	public class PlanExtension : BasePlanExtension
	{
		...
		public override IEnumerable<ElementError> Validate()
		{
			...
			FiresecManager.PlansConfiguration.AllPlans.ForEach(plan =>
				errors.AddRange(FindUnbindedErrors<ElementRectangleTank, ShowGKDeviceEvent, Guid>(plan.ElementExtensions.OfType<ElementRectangleTank>(), plan.UID, "Несвязанный бак", "/Controls;component/Images/Tree.png", Guid.Empty)));
			return errors;
		}
