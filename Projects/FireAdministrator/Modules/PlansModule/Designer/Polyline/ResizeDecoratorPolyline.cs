...
namespace PlansModule.Designer
{
    public class ResizeDecoratorPolyline : Control
    {
        ...
        public static readonly DependencyProperty ShowDecoratorProperty =
            DependencyProperty.Register("ShowDecorator", typeof(bool), typeof(ResizeDecoratorPolyline),
            new FrameworkPropertyMetadata(false, new PropertyChangedCallback(ShowDecoratorProperty_Changed)));

        public ResizeDecoratorPolyline()
        {
        ...
        private void ShowAdorner()
        {
            if (this.adorner == null)
            {
                ...
                if (adornerLayer != null)
                {
                    ...
                    this.adorner = new ResizeAdornerPolyline(designerItem);
        ...
        {
            ResizeDecoratorPolyline decorator = (ResizeDecoratorPolyline)dependencyObject;
