...
namespace GKIntegratedTest
{
	public partial class ItegratedTest
	{
		...
		public void TestHandDetectorFire2()
		{
			...
			CheckTime(() => WaitWhileState(device, XStateClass.Norm, 10000), "Инициализация состояний");
			...
			CheckTime(() => WaitWhileState(device, XStateClass.Fire2, 3000), "Ждем пожар2 в ИПР");
			...
			CheckTime(() => WaitWhileState(device, XStateClass.Norm, 3000), "Ждем норму в ИПР");
