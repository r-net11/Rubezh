...
namespace ComEmulator
{
    public class ComServerEmulatorViewModel : INotifyPropertyChanged
    {
        ...
        public void OnFireEvent(object parameter)
        {
            ComEventAggregator.OnComEvent(StateMessage, GetCoreState());
        }
