...
//            Services.Configuration.CoreConfig.dev = new Firesec.CoreConfig.devType[1];
//            Services.Configuration.CoreConfig.dev[0] = null;// device.InnerDevice;
...
//                Services.Configuration.CoreConfig.zone[i].no = Services.Configuration.Zones[i].No;
...
//        List<Firesec.CoreConfig.propType> AddCustomProperties(ShortDevice device)
//        {
...
//                                    {
//                                        //Firesec.Metadata.propInfoType propertyInfo = metadataDriver.propInfo.FirstOrDefault(x => x.name == deviceProperty.Name);
