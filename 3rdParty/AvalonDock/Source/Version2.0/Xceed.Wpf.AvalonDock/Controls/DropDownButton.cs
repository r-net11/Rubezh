...
namespace Xceed.Wpf.AvalonDock.Controls
{
	...
	{
		private WeakReference _menuReference = null;

		public DropDownButton()
		{
			Loaded += new RoutedEventHandler(DropDownButton_Loaded);
		...
		void DropDownButton_Loaded(object sender, RoutedEventArgs e)
		{
			if (DropDownContextMenu == null && _menuReference != null)
			{
				if (_menuReference.IsAlive)
					DropDownContextMenu = (ContextMenu)_menuReference.Target;
				else
					_menuReference = null;
			}
		}
		...
		{
			if (DropDownContextMenu != null)
				_menuReference = new WeakReference(DropDownContextMenu);
