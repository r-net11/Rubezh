	...
	public abstract class LayoutItem : FrameworkElement
	{
		...
		private bool CanExecuteCloseAllButThisCommand(object parameter)
		{
			...
			return (LayoutElement.Root == null || LayoutElement.Root.Manager.AllowChangeLayout) &&
				LayoutElement.Root.Manager.Layout.Descendents().OfType<LayoutContent>().Where(d => d != LayoutElement && (d.Parent is LayoutDocumentPane || d.Parent is LayoutDocumentFloatingWindow)).Any();
		}
