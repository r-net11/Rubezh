...
namespace TestServiceClient
{
    ...
    public class ControlService : ServiceReference.IStateServiceCallback
        ...
        public event Action EventChange;
            ...
            void TestServiceClient.ServiceReference.IStateServiceCallback.Notify(string message)
            {
...
//            {
 ...
 //           }
            ...
            void TestServiceClient.ServiceReference.IStateServiceCallback.ComChanged(TestServiceClient.ServiceReference.ComDevice comDevice)
            {
            ...
            {
                List<TestServiceClient.ServiceReference.ComDevice> devices = service.GetComDevices();
                plainComDevices = new List<TestServiceClient.ServiceReference.ComDevice>(devices);
                ...
                viewModel.Devices = new System.Collections.ObjectModel.ObservableCollection<TestServiceClient.DeviceDescriptor>();
