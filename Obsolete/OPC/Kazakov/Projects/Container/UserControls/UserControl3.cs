...
namespace AControls
{
    ...
    [Guid("8408D569-6082-4171-9736-A7BCADA61652")]
    public partial class Control3 : UserControl
    {
        ...
        private void panel_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.FillEllipse(new SolidBrush(PenColor), new RectangleF(((float)((float)6 / (float)18)) * panel.Width, ((float)((float)12 / (float)18)) * panel.Height, ((float)((float)5 / (float)18)) * panel.Width, ((float)((float)5 / (float)18)) * panel.Height));
        }
