...
namespace AControls
{
    ...
    [Guid("CBEFB22E-042A-405b-ACC2-88375EDC6028")]
    public partial class Control4 : UserControl
    {
            ...
            set
            {
                ...
                switch (state)
                {
                    ...
                    case 1:
                        ...
                        break;
                    // Обнаружена неисправность. Потеря связи с прибором
                    case 2:
                        timer1.Enabled = false;
                        PenColor = Color.Black;
                        panel.BackColor = Color.Yellow;
        ...
        {   
            ...
            e.Graphics.FillRectangle(new SolidBrush(PenColor), (float)((float)11 / (float)18) * panel.Width, 0, (float)((float)7 / (float)18) * panel.Width, (float)((float)7 / (float)18) * panel.Height);
        }
