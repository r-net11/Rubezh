...
%NAntPath% -logger:NAnt.Core.XmlLogger -logfile:buildlog_BuildReleaseLicFree.xml -buildfile:nant/BuildReleaseLicFree.build -D:InstallerAssemblyNamePrefix= -D:InstallerAssemblyName=A.C.Tech -D:OurProductVersion=1.0.1 -D:OurProductBuildNumber=0
echo END