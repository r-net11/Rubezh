...
%NAntPath% -logger:NAnt.Core.XmlLogger -logfile:buildlog_BuildRelease.xml -buildfile:nant/BuildRelease.build -D:InstallerAssemblyNamePrefix= -D:InstallerAssemblyName=A.C.Tech -D:OurProductVersion=1.0.3 -D:OurProductBuildNumber=7 -D:Culture=ru
echo END